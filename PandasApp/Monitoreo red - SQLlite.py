...
def procesar_archivos_csv(folder_path, processed_files_path):
    ...
    unprocessed_files = [f for f in all_files if os.path.abspath(f) not in processed_files]
...
def cargar_datos_datawarehouse(df, database_path, table_name="Monitoreo_red"):
